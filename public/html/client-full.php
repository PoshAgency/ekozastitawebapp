							...
							<div class="flex flex-wrap justify-between">
								<div class="items-center ">
									...
									<ol class="list-reset flex text-sm">
										<li><a href="#" class="text-gray-500 dark:text-slate-400">Ekozaštita</a></li>
										<li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
										<li class="text-gray-500 dark:text-slate-400">Klijenti</li>
										<li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
										<li class="text-primary-500 hover:text-primary-600 dark:text-primary-400">Detalji</li>
									</ol>
								</div>
							</div>
						</div>
					...
					<div class="">
						...
						<div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
							...
							<div class="col-span-12 sm:col-span-12 md:col-span-7">
								<span class="dark:text-slate-400">Srbija</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-5 text-end">
							...
							<div class="col-span-12 sm:col-span-12 md:col-span-7">
								<span class="dark:text-slate-400">11000 Beograd</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-5 text-end">
								<span class="dark:text-slate-300">PIB:</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-7">
								<span class="dark:text-slate-400">103482850</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-5 text-end">
								<span class="dark:text-slate-300">Matični broj:</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-7">
								<span class="dark:text-slate-400">17569171</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-5 text-end">
								<span class="dark:text-slate-300">Email:</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-7">
								<span class="dark:text-slate-400">office@delhaize.rs</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-5 text-end">
								<span class="dark:text-slate-300">Web:</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-7">
								<span class="dark:text-slate-400"><a href="https://www.maxi.rs">www.maxi.rs</a></span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-5 text-end">
								<span class="dark:text-slate-300">Telefon:</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-7">
								<span class="dark:text-slate-400">+381 11 7153 400</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-5 text-end">
							...
							<div class="col-span-12 sm:col-span-12 md:col-span-7">
								<span class="dark:text-slate-400">Maja Mandić</span>
							</div>
							<div class="col-span-12 sm:col-span-12 md:col-span-5 text-end">
					...
					<div class="grid  grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 p-4">
						<div class="bg-primary-500/5 dark:bg-primary-500/10 border border-dashed border-primary-500  rounded-md w-full relative ">                                
							<div class="flex-auto p-4 text-center">                                       
								...
								<h4 class="my-1 font-semibold text-3xl dark:text-slate-200">564</h4>
						...
						<div class="bg-purple-500/5 dark:bg-cyan-500/5 border border-dashed border-purple-500  rounded-md w-full relative ">                                
							<div class="flex-auto p-4 text-center">
								...
								<h4 class="my-1 font-semibold text-3xl dark:text-slate-200">4</h4>
							...
							<div class="mb-4 border-b border-gray-200 dark:border-slate-700" data-fc-type="tab">
								<ul class="flex flex-wrap -mb-px text-sm font-medium text-center" aria-label="Tabs">
									<li class="me-2" role="presentation">
										<button class="inline-block p-4 rounded-t-lg border-b-2 active " id="orders-tab" data-fc-target="#orders" type="button" role="tab" aria-controls="orders" aria-selected="false">Objekti <span class="text-gray-500 dark:text-slate-400">(564)</span></button>
									</li>
									<li class="me-2" role="presentation">
												...
												<table class="w-full">
													...
													<tbody>
														...
														<tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
															...
															<td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400 text-right">
																<a class="mr-3" href="work-order-full-edit.php"><i class="icofont-ui-edit text-xxl text-gray-500 dark:text-gray-400"></i></a>
																<a class="mr-3" href="javascript:;"><i class="icofont-ui-delete text-xxl text-red-500 dark:text-red-400" data-fc-type="modal" data-fc-target="smallmodal"></i></a>
															</td>
														</tr>
														<!-- 2 -->
												...
												<table class="w-full">
													...
													<tbody>
														...
														<tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
															...
															<td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400 text-right">
																<a class="mr-3" href="user-full-edit.php"><i class="icofont-ui-edit text-xxl text-gray-500 dark:text-gray-400"></i></a>
																<a class="mr-3" href="javascript:;"><i class="icofont-ui-delete text-xxl text-red-500 dark:text-red-400" data-fc-type="modal" data-fc-target="smallmodal"></i></a>
															</td>
														</tr>
														<!-- 2 -->
