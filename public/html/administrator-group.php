...
<body data-layout-mode="light" data-sidebar-size="default" data-theme-layout="vertical" class="administrator-group-page bg-[#EEF0FC] dark:bg-gray-900">
						...
						<div class="flex flex-wrap justify-between">
							<div class="items-center">
								...
								<ol class="list-reset flex text-sm">
									...
									<li class="text-primary-500 hover:text-primary-600 dark:text-primary-400">Korisnici</li>
								</ol>
							</div>
					...
					<div class="w-full relative mb-4">  
						<div class="flex-auto p-0 md:p-4">
							<div class="flex flex-wrap gap-4 mb-3">
								...
								<div>
									<a href="administrator-full-edit.php" class="inline-block focus:outline-none bg-brand-500 mt-1 text-white hover:bg-brand-600 hover:text-white  text-md font-medium py-2 px-4 rounded">
													...
													<tbody>
														...
														<tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
															...
															<td class="p-3 text-sm font-medium whitespace-nowrap dark:text-white">
																<a href="administrator-full-edit.php" class="flex items-center">
