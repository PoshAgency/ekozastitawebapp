...
<body data-layout-mode="light" data-sidebar-size="default" data-theme-layout="vertical" class="preparation-group-page bg-green-50 dark:bg-gray-900">
						...
						<div class="flex flex-wrap justify-between items-center">
							<div class="items-center">
								...
								<ol class="list-reset flex text-sm">
									...
									<li class="text-green-500 dark:text-gray-400">Preparati</li>
								</ol>
							</div>
                            <div class="ms-auto">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                                                                    ...
                                                                    <td class="p-3 text-sm font-medium whitespace-nowrap dark:text-white">
                                                                        <a href="preparations/edit" class="flex items-center">
                                                                    ...
                                                                    <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400 text-right">
                                                                        <a class="mr-3" href="preparations/edit"><i class="icofont-ui-edit text-xxl text-gray-500 dark:text-gray-400"></i></a>
