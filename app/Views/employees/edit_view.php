...
<body data-layout-mode="light" data-sidebar-size="default" data-theme-layout="vertical" class="employees-edit-page bg-green-50 bg-[#EEF0FC] dark:bg-gray-900">
						...
						<div class="flex flex-wrap justify-between">
							<div class="items-center">
								...
								<ol class="list-reset flex text-sm">
									...
									<li class="text-gray-500 dark:text-slate-400">Operativci</li>
									<li>
										<span class="text-gray-500 dark:text-slate-400 mx-2">/</span>
									</li>
									<li class="text-primary-500 hover:text-primary-600 dark:text-primary-400">Novi operativac</li>
								</ol>
							</div>
						</div>
					</div>
