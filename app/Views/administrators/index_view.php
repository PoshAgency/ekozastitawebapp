...
<body data-layout-mode="light" data-sidebar-size="default" data-theme-layout="vertical" class="administrators-group-page bg-green-50 dark:bg-gray-900">
						...
						<div class="flex flex-wrap justify-between items-center">
							<div class="items-center">
								...
								<ol class="list-reset flex text-sm">
									...
									<li class="text-green-500 dark:text-gray-400">Administratori</li>
								</ol>
							</div>
                            <div class="ms-auto">
                                <a href="administrators/edit" class="inline-block focus:outline-none bg-brand-500 mt-1 text-white hover:bg-brand-600 hover:text-white  text-md font-medium py-2 px-4 rounded">
                                    Dodaj korisnika
                                </a>
                            </div>
						</div>
										...
										<div class="sm:-mx-6 lg:-mx-8">
											<div class="relative overflow-x-auto block w-full sm:px-2 lg:px-4">
                                                <div class="bg-white rounded-md shadow-md">
                                                    <div class="py-4">
                                                        <table class="w-full border-collapse" id="admnistrators_table">
