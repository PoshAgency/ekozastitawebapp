			...
			<ul class="navbar-nav">
				<li>
					<div id="parent-accordion" data-fc-type="accordion">
                        ...
                        <?php if(in_array(session('user')['group_id'], [1,2])){ ?>
